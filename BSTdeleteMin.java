 ...
 *  @author Kevin Wayne
 */
public class BSTdeleteMin<Key extends Comparable<Key>, Value> {
    private Node root;             // root of BST
    private Node NodeQualuer;
    ...
    private Value get(Node x, Key key) {
       ...
       public String getSise(Key key)
       {
    	   return getSise(root, key);
    	   
       }
    private String getSise(Node x,Key key) {
        if (key == null) throw new IllegalArgumentException("called get() with a null key");
        
        if (x == null) return null;
        int cmp = key.compareTo(x.key);
        if      (cmp < 0) return getSise(x.left, key);
        else if (cmp > 0) return getSise(x.right, key);
        else              return x.key+" "+x.size+" valor "+x.val;
    }
  ...
  /* private Node deleteMin(Node x) {
   ...
   /* private Node deleteMin(Node x) {
    	...
    	while(x.left != null){
        	...
        	System.out.println("percorre nó"+ x.key);
    	...
    	while(!stack.isEmpty()){
    	    ...
    	    x.left = left;
    	    System.out.println("Desemplihando nó "+ x.key);
    	    x.size = 1+size(x.left) + size(x.right);	
    	    left = x;
    	}
            return x;	
  ...
  /*************************************************************************
    ...
    ***************************************************************************/
    ...
    public static void main(String[] args) { 
        BSTdeleteMin<String, Integer> st = new BSTdeleteMin<String, Integer>();
