...
private int numchaves;
  ...
  public Integer min()
  {
	  ...
	  {
		  Pagina p = raiz;
		  while(p.p[0]!=null) p = p.p[0];
		  return (Integer) p.r[0].recuperaChave();
  ...
  public Integer max()
  {
	  ...
	  {
		  Pagina p = raiz;
		  while(p.p[p.n] !=null) p = p.p[p.n];
		  return (Integer) p.r[p.n-1].recuperaChave();
  ...
  private void percorreB (Pagina p)
  {
	  if(p!=null)
	  {
		  numchaves= numchaves+p.n;
